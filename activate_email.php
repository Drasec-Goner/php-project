<?php
	...
	$mail->Password = 'oput wufv lyza bdry';                           // SMTP password
	$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	$mail->Port = 587;                                    // TCP port to connect to
	$to=$_SESSION['email_address'];
	$mail->setFrom('drasec.04@gmail.com', 'Musically');
	...
	http://localhost/musically/verify.php?email_address=".$_SESSION['email_address']."&activation_code=".$_SESSION['activation_code']."  "; // Our message above including the link

...
<head>
	<title>Musically | Bengali Songs</title>
...
<body>
	...
	<header>
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
                ...
                <li class="nav-item">
                    ...
                    <p style="color:blue;">| Bengali Songs |</p>
                </li>
      ...
      aria-haspopup="true" aria-expanded="false">Track</button>
								<div class="dropdown-menu dropdown-primary">
									<a class="dropdown-item" href="bengali_songs.php"><b>Bengali Songs</b></a>
		...
		<?php
			...
			if(mysqli_num_rows($result)>0){
				while($row = mysqli_fetch_array($result)){
					...
					echo "
							<div class='col-md-3'>
								<form method='post' action='bengali_songs.php'>
									<div class='card-deck'>
										<div class='card-img'>
											<img src='songs/bengali_songs/img/$song_image' style='width:350px;height:250px;'alt=''>
										</div>
										<div class='card-desc'>
											<h3>$song_name | $singer_name</h3>
											<h3>movie - $movie_name</h3>
											<audio class='embed-responsive-item' controls='' preload='none'> <source src='songs/bengali_songs/$audio_file' type='audio/mp3'></audio><br>
	...
	<div class="contact-top text-center" id="more_info">
		<div class="content-contact-top">
			...
			<p class="text-white w-75 mx-auto">Musically a unique platform for upcoming singers.
			</p>
		</div>
	</div>
	<!-- //contact top -->
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>email</h6>
								<p>
									<a href="mailto:drasec.04@email.com" class="text-dark">admin@musicalworld.com</a>
								</p>
							</div>
						</div>
					</div>
	...
	<div class="cpy-right text-center">
		<p>© 2024 Musically. All rights reserved</p>
	</div>
    <!-- //copyright -->
    <!-- js-->
